...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ai::get_alerts,
            commands::shell::open_url,
            commands::settings::get_settings,
            commands::settings::set_setting,
            commands::settings::delete_setting,
            commands::settings::test_connection,
            commands::settings::get_rss_sources,
            commands::settings::list_ai_models,
            commands::settings::save_ai_model,
            commands::settings::remove_ai_model,
            commands::settings::test_ai_model,
            commands::credit_cycle::get_credit_cycle_overview,
            commands::credit_cycle::get_dollar_tide,
            commands::credit_cycle::get_country_credit_detail,
            commands::game_map::get_policy_vectors,
            commands::game_map::get_bilateral_dynamics,
